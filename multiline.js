...
//Create scale functions
    chartObj.xScale = d3.scale.linear().range([0, chartObj.width]).domain([1, 26]); //< Can be overridden in definition
...
// Render the chart
    chartObj.render = function () {
        ...
        function mousemove() {
            ...
            focus.select(".focus.year").text("Número da letra: " + chartObj.xFormatter(chartObj.xFunct(d)));
        }
